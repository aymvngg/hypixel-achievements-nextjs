...
function computePlayerGameBreakdown(views: AchievementView[]): Map<
	string,
	{
		obtained: number;
		missing: number;
...
export function sortCompareRows(
	...
	return [...rows].sort((a, b) => {
		const aDiff =
			metric === "obtained"
				? a.p1Obtained - a.p2Obtained
				: a.p1Missing - a.p2Missing;
		const bDiff =
			metric === "obtained"
				? b.p1Obtained - b.p2Obtained
				: b.p1Missing - b.p2Missing;
