...
export function formatRankPrefix(
	...
	const segments = buildRankPrefixSegments(rank, plusColorHex, prefixColorHex, rawPrefix)
...
export function parseMinecraftColoredText(rawText: string, appendTrailingSpace = false): ColoredSegment[] {
