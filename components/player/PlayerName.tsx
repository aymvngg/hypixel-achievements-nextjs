...
export function PlayerName({
	...
	const nickname = player.nickname && player.nickname !== "UNKNOWN" ? player.nickname : (fallback ?? "Unknown")
	const nicknameColor = getNicknameColor(player.rank, player.rankPrefixColor, player.rankPrefix)
