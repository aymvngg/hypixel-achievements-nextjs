		...
		>
			<div className="flex gap-2">
				{[0, 1, 2].map((i) => (
					<span
						key={i}
						className="block h-4 w-4 bg-mc-grass border-2 border-mc-border shadow-[inset_1px_1px_0_rgba(255,255,255,0.3),inset_-1px_-1px_0_rgba(0,0,0,0.3)] animate-bounce motion-reduce:animate-none"
