...
export function PixelButton({
  ...
  return (
    <button
      type="button"
      className={`border-[3px] border-mc-border shadow-[inset_2px_2px_0_rgba(255,255,255,0.12),inset_-2px_-2px_0_rgba(0,0,0,0.3),3px_3px_0_rgba(0,0,0,0.35)] font-[family-name:var(--font-pixel)] uppercase tracking-[0.02em] px-4 py-2 text-sm ${variants[variant]} ${className}`}
      {...props}
    >
      {children}
    </button>
